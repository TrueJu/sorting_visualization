...
const Article = ({ title="default", description="...", animationScript, sourceCodes=[], timeAndSpace, id }:articleProps) => {
    ...
    return(
        <div className="  w-full" id={id}>
            ...
            {animationScript === "notAnimated" ? null :
            ...
            {animationScript === "notAnimated" ? <h3 className="w-full text-center my-7 font-bold text-red-gradient">This algorithm is not yet animated</h3> :
            <button  onClick={() => {
            ...
            }} type="button" id="runAnimationBtn" className="ml-[50%] translate-x-[-50%] mb-12 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Run Animation
            ...
            <button disabled type="button" id="animationRunningBtn" className="hidden mb-12 ml-[50%] translate-x-[-50%] py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 items-center">
